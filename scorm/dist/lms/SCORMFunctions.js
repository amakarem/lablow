...
function SCORM_TranslateExitTypeToSCORM(strExitType){
	...
	if (strExitType == EXIT_TYPE_SUSPEND){
		...
		WriteToDebug("Returning Timeout");
...
function SCORM_GrabAPI(){
	...
	//if it's still not found, look in every conceivable spot...some older LMS's bury it in weird places
	//drop this because it can cause problems when the content is launched in a cross domain environment...for instance the 
