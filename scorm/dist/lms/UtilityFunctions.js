...
function ConvertScorm2004TimeToMS(strIso8601Time){
	...
	var Seconds = 0;	// 100 hundredths of a seconds
...
function ConvertMilliSecondsToSCORMTime(intTotalMilliseconds, blnIncludeFraction){
	...
	note - this case is permissible under SCORM, but will be exceptionally rare
	*/
...
function ConvertMilliSecondsIntoSCORM2004Time(intTotalMilliseconds){
	...
	var HundredthsOfASecond;	//decrementing counter - work at the hundredths of a second level because that is all the precision that is required
	
	var Seconds;	// 100 hundredths of a seconds
